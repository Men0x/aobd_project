...
import re
    ...
    """
        ...
        ---------------------
        This module contains the preprocessing train and preprocessing test.
    """

def preprocessing_train():
     """
        Returns a object dataframe claned.

        :param uuids: no parameters
        :return: object dataframe preprocessed
        :rtype: object On Python 3.x, this returns a dataframe view object,
    """
